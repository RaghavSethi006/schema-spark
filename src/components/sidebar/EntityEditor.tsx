    ...
    <Tabs defaultValue="entity" className="h-full flex flex-col">
      <div className="px-4 pt-4 pb-2 border-b border-border">
        <TabsList className="w-full grid grid-cols-2">
          <TabsTrigger value="entity" className="text-xs gap-1">
      ...
      <ScrollArea className="flex-1">
        <TabsContent value="entity" className="m-0 h-full">
          <EntityTab entity={entity} />
        </TabsContent>
...
const EntityTab = ({ entity }: { entity: ReturnType<typeof useSchemaStore.getState>['getEntityById'] extends (id: string) => infer R ? R : never }) => {
  const { 
    schema,
    selectedFieldId,
    updateEntity,
